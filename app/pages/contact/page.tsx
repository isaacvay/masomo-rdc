            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
              ...
              <div className="space-y-8">
                <ContactCard 
                  title="Coordonnées"
                  items={[
                    { icon: 'map', text: '123 Rue de l\'Éducation, Paris, France' },
    ...
    {social.length > 0 && (
      <div className="flex space-x-4 mt-6">
        {social.map((platform, index) => (
          ...
          >
            <SocialIcon icon={platform.icon as "facebook" | "twitter" | "linkedin" | "instagram"} />
          </a>
        ))}
      </div>
    )}
...
const SocialIcon = ({ icon }: { icon: "facebook" | "twitter" | "linkedin" | "instagram" }) => {
  const icons: { [key in "facebook" | "twitter" | "linkedin" | "instagram"]: string } = {
